                                ...
                                <div className="row g-3">
                                    <div className="col-md-6">
                                        <div className="form-floating">
                                            <input type="text" className="form-control" id="name" name='username' placeholder="Your Name" />
                                    ...
                                    <div className="col-12">
                                        <div className="form-floating">
                                            <textarea className="form-control" name='massage' placeholder="Leave a message here" id="message" style={{ height: "120px" }}></textarea>
